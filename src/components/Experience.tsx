...
//     role: 'AX 팀장',
//     sub: '개발 / 기획 / 설계 / 자동화 구축',
//     title: 'AI Transformation · 기획 · 개발 · 자동화',
//     desc: 'AX팀 팀장으로 합류해 서비스 기획, 프로세스 설계, 개발, 자동화 구축 전 과정을 주도했습니다. 개발·비개발 직군 간 커뮤니케이터 역할을 담당하며 각 사업부의 니즈를 기술 요구사항으로 번역했습니다.',
//     achievements: [
...
//                 {/* 타임라인 도트 */}
//                 <div style={{
//                   position: 'absolute', left: 207, top: 54,
...
//                 }} />
//                 <div style={{
//                   position: 'absolute', left: 214, top: 60, bottom: 0,
//                   width: 1, background: 'var(--border)',
//                 }} />

//                 {/* 메타 */}
//                 <div style={{ paddingTop: 4 }}>
//                   <p style={{ fontFamily: 'JetBrains Mono, monospace', fontSize: 11, color: 'var(--text3)', marginBottom: 10 }}>
//                     {exp.period}
//                   </p>
//                   <p style={{ fontFamily: 'Syne, sans-serif', fontSize: 15, fontWeight: 700, color: 'var(--text)', marginBottom: 4 }}>
//                     {exp.company}
//                   </p>
...
//                 {/* 내용 */}
//                 <div>
//                   <h3 style={{ fontFamily: 'Syne, sans-serif', fontSize: 22, fontWeight: 700, color: 'var(--text)', marginBottom: 12, marginTop: 4 }}>
//                     {exp.title}
//                   </h3>
//                   <p style={{ fontSize: 15, color: 'var(--text2)', lineHeight: 1.85, marginBottom: 20 }}>
//                     {exp.desc}
//                   </p>
...
//                       <p style={{ fontFamily: 'Syne, sans-serif', fontSize: 16, fontWeight: 700, color: 'var(--text)', marginBottom: 10 }}>
//                         {exp.kma.title}
//                       </p>
...
const experiences = [
  {
    ...
    company: '머스트컴퍼니',
    role: 'AX팀 팀장',
    sub: '팀원 3~5명 · 개발 / 기획 / 설계 / 자동화 구축 주도',
    ...
    tags: ['n8n', 'Slack API', 'Notion API', 'LiteLLM', 'Claude Code', 'Jira'],
  },
  {
